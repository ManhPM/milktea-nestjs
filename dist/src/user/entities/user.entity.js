...
__decorate([
    (0, typeorm_1.OneToMany)(() => cart_product_entity_1.CartProduct, (item) => item.user),
    __metadata("design:type", Array)
], User.prototype, "cart_products", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => account_entity_1.Account, (item) => item.user),
    __metadata("design:type", account_entity_1.Account)
], User.prototype, "account", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => invoice_entity_1.Invoice, (item) => item.user),
    __metadata("design:type", Array)
], User.prototype, "invoices", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => wishlist_entity_1.Wishlist, (item) => item.user),
    __metadata("design:type", Array)
], User.prototype, "wishlists", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => review_entity_1.Review, (item) => item.user),
    __metadata("design:type", Array)
