...
__decorate([
    (0, typeorm_1.ManyToOne)(() => recipe_entity_1.Recipe, (recipe) => recipe.recipe_ingredients),
    __metadata("design:type", recipe_entity_1.Recipe)
], RecipeIngredient.prototype, "recipe", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => ingredient_entity_1.Ingredient, (ingredient) => ingredient.recipe_ingredients),
